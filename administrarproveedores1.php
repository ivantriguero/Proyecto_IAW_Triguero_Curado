...
<div class="row justify-content-center" id="c2" >
    <div class="col-md-6">
        ...
        if ($connection->connect_errno) {
          ...
          $query="select * from proveedores where cod_proveedor='".$_GET['id']."';";
        ...
        if ($result->num_rows==0) {
            var_dump($_POST);
          $query="update proveedores set nombre='".$_POST["nombre"]."',tlf=".$_POST["tlf"]." WHERE cod_proveedor=".$cod."";

          if ($result = $connection->query($query)) {
            header('Location: administrarproveedores.php?editado=si');
