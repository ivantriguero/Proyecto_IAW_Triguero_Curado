...
if (array_key_exists('id', $_GET)) {
    ...
    if ($connection->connect_errno) {
      ...
      $query="delete from pedidos where cod_pedido=".$_GET['id'].";";
    Echo "<h1 style='color:green'>Pedido entregado correctamente</h1>";
    if ($result = $connection->query($query)) {}
        ...
        if ($result = $connection->query($query)) {}
          ...
          while($obj = $result->fetch_object()) {
            ...
            echo "<td><a href='administrarpedidos.php?id=".$obj->cod_pedido."' class='btn btn-primary'>Pedido realizado</a></td>";
            echo "</form>";
            echo "<tr>
            ";
